                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            border: InputBorder.none,
                            hintText: 'Upload your profile picture',
                            hintStyle: GoogleFonts.getFont(
                              'Rubik',
                              fontWeight: FontWeight.w400,
                              fontSize: 14,
                    ...
                    Align(
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          int result = await registerTutor(nameController.text, aboutController.text, phoneController.text,
                            emailController.text,  passwordController.text,   profilePictureController.text,
                            int.parse(ageController.text), genderController.text, documentController.text, tutorStatus);
